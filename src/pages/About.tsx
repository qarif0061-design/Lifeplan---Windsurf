    ...
    <PublicPageLayout>
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        <div className="space-y-3">
          <h1 className="text-3xl font-bold text-foreground">About Lifeplans</h1>
        ...
        <div className="space-y-6 text-foreground/80">
          <div className="space-y-2">
            <h2 className="text-xl font-bold text-foreground">What we help you do</h2>
            <p>
          ...
          <div className="space-y-2">
            <h2 className="text-xl font-bold text-foreground">Who Lifeplans is for</h2>
            <p>
          ...
          <div className="space-y-2">
            <h2 className="text-xl font-bold text-foreground">Our content approach</h2>
            <p>
          ...
          <div className="space-y-2">
            <h2 className="text-xl font-bold text-foreground">The Lifeplans story</h2>
            <p>
          ...
          <div className="space-y-2">
            <h2 className="text-xl font-bold text-foreground">Our commitment to privacy</h2>
            <p>
          ...
          <div className="space-y-2">
            ...
            <p>
              ...
              <a href="/contact" className="text-primary hover:underline">contact page</a> or email us directly.
          ...
          <div className="mt-8 p-6 bg-primary/10 rounded-2xl border border-primary/20">
            <h2 className="text-xl font-bold text-foreground mb-2">Start using Lifeplans today</h2>
            <p className="mb-4">
