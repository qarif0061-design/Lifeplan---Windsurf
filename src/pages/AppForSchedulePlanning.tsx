            ...
            <div className="bg-blue-50 rounded-2xl p-8 border border-blue-100">
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900">Define your priorities</h4>
                    <p className="text-blue-700">Identify the key areas of your life that deserve scheduled time.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900">Allocate time blocks</h4>
                    <p className="text-blue-700">Assign time blocks for each priority area across your week.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900">Create templates</h4>
                    <p className="text-blue-700">Build a reusable weekly template that reflects your ideal schedule.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700">Each week, compare plan vs reality and adjust your template.</p>
                  </div>
                </div>
              </div>
            </div>
