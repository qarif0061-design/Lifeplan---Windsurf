              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80">Choose a routine app that fits your style. Goal Planner – LifePlans is a great start.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Create your first routine</h4>
                    <p className="text-foreground/80">Start with a simple morning routine of 3-5 steps.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Use reminders</h4>
                    <p className="text-foreground/80">Enable notifications to prompt you through each routine step.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Stay consistent</h4>
                    <p className="text-foreground/80">Follow your routine for 2-3 weeks until it becomes automatic.</p>
                  </div>
                </div>
              </div>
            </div>
