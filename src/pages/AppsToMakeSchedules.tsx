            ...
            <div className="bg-blue-50 rounded-2xl p-8 border border-blue-100">
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900">Choose your format</h4>
                    <p className="text-blue-700">Decide whether daily, weekly, or monthly scheduling works best for you.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900">Set your fixed commitments</h4>
                    <p className="text-blue-700">Add all fixed events like meetings, classes, and appointments first.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900">Add flexible tasks</h4>
                    <p className="text-blue-700">Schedule priority tasks during your peak energy windows around fixed commitments.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900">Review and refine</h4>
                    <p className="text-blue-700">At the end of each week, review what worked and improve your scheduling approach.</p>
                  </div>
                </div>
              </div>
            </div>
