            ...
            <div className="bg-blue-50 rounded-2xl p-8 border border-blue-100">
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900">Identify your planning style</h4>
                    <p className="text-blue-700">Do you prefer time-blocking, task lists, or a combination?</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900">Choose your app</h4>
                    <p className="text-blue-700">Pick a daily planner that matches your preferred planning style.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700">Configure priorities, create templates, and set up recurring items.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900">Use it daily</h4>
                    <p className="text-blue-700">Commit to daily planning for 2-3 weeks to establish the habit.</p>
                  </div>
                </div>
              </div>
            </div>
