            ...
            <div className="bg-primary/10 rounded-2xl p-8 border border-primary/20">
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Choose your habit</h4>
                    <p className="text-foreground/80">Pick one habit that will have the biggest positive impact on your life.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80">Make the habit so easy you can't say no. 2 minutes is better than 30 minutes if it means you'll actually do it.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80">Track your habit every day. The act of logging reinforces the behavior and builds awareness.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Stack and grow</h4>
                    <p className="text-foreground/80">Once the habit is automatic, add a new one or increase the difficulty.</p>
                  </div>
                </div>
              </div>
            </div>
