            ...
            <div className="bg-primary/5 rounded-2xl p-8 border border-primary/10">
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Pick your top goal</h4>
                    <p className="text-foreground/80">Each morning, choose 1-3 things that would make the day successful if completed.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Set a clear outcome</h4>
                    <p className="text-foreground/80">Define what done looks like for each goal. Vague goals lead to vague results.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Track and check off</h4>
                    <p className="text-foreground/80">As you complete each daily goal, check it off. The satisfaction of completion builds momentum.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-foreground">Review and reset</h4>
                    <p className="text-foreground/80">At end of day, review what you accomplished and set tomorrow's goals.</p>
                  </div>
                </div>
              </div>
            </div>
