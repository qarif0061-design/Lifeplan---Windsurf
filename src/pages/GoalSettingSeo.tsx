    ...
    <PublicPageLayout>
      ...
      <div className="space-y-10">
        <header className="space-y-3">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900">Goal Setting</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Button asChild className="rounded-full bg-blue-600 hover:bg-blue-700">
              <Link to="/auth">Start setting your goals</Link>
            </Button>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-900">Why goal setting matters</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="rounded-[2rem] border border-gray-100 bg-white shadow-sm">
              ...
              <CardContent className="text-gray-700">Goals give you a clear destination. Instead of wandering, every decision moves you toward what matters most.</CardContent>
            </Card>
            <Card className="rounded-[2rem] border border-gray-100 bg-white shadow-sm">
              <CardHeader><CardTitle className="text-lg">Motivation</CardTitle></CardHeader>
              <CardContent className="text-gray-700">Written goals create commitment. Each small win releases dopamine, keeping you motivated for the next step.</CardContent>
            </Card>
            <Card className="rounded-[2rem] border border-gray-100 bg-white shadow-sm">
              <CardHeader><CardTitle className="text-lg">Measurement</CardTitle></CardHeader>
              <CardContent className="text-gray-700">What gets measured gets done. Goals let you track progress and know when you've arrived.</CardContent>
            </Card>
          </div>
        </section>

        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-900">The goal achievement system</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-900">Why people fail at goals (and how to fix it)</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="rounded-[2rem] border border-gray-100 bg-white shadow-sm">
              <CardHeader><CardTitle className="text-lg">Too vague</CardTitle></CardHeader>
              <CardContent className="text-gray-700"><strong>Fix:</strong> Use SMART. "Get fit" becomes "Run 3x/week for 30 minutes."</CardContent>
            </Card>
            <Card className="rounded-[2rem] border border-gray-100 bg-white shadow-sm">
              <CardHeader><CardTitle className="text-lg">No plan</CardTitle></CardHeader>
              <CardContent className="text-gray-700"><strong>Fix:</strong> Break goals into weekly tasks. Plan each week on Sunday or Monday.</CardContent>
            </Card>
            <Card className="rounded-[2rem] border border-gray-100 bg-white shadow-sm">
              <CardHeader><CardTitle className="text-lg">Too many goals</CardTitle></CardHeader>
              <CardContent className="text-gray-700"><strong>Fix:</strong> Focus on 1-3 goals per quarter. Finish before adding more.</CardContent>
            </Card>
            <Card className="rounded-[2rem] border border-gray-100 bg-white shadow-sm">
              <CardHeader><CardTitle className="text-lg">No tracking</CardTitle></CardHeader>
              <CardContent className="text-gray-700"><strong>Fix:</strong> Use a goal tracking app or weekly planner. Review progress every Friday.</CardContent>
            </Card>
          </div>
        </section>

        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-900">Goal setting for different areas</h2>
          <div className="rounded-[2rem] border border-blue-100 bg-blue-50 p-7 shadow-sm space-y-4">
            <p className="text-gray-700"><strong>For work:</strong> Set goals using the SMART framework during performance reviews. Align personal goals with team and company objectives.</p>
            <p className="text-gray-700"><strong>For students:</strong> Set academic, skill, and personal development goals. Use a student planner to track assignments and study targets.</p>
            <p className="text-gray-700"><strong>For ADHD:</strong> Keep goals simple, visible, and time-boxed. Use short deadlines, accountability partners, and habit stacking for better follow-through.</p>
            <p className="text-gray-700"><strong>For personal development:</strong> Set goals across health, relationships, learning, and finances. Use a life planner to keep everything balanced.</p>
          </div>
        </section>
