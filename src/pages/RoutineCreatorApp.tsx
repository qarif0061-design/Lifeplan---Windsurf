...
const RoutineCreatorApp = () => {
  ...
  const faqData = [
    ...
    {"question":"How long should my routines be?","answer":"Morning routines typically work best at 15-60 minutes. Evening routines at 15-45 minutes. Keep them realistic so you can maintain them consistently."},
    {"question":"Can I have different routines for different days?","answer":"Yes. A good routine creator app lets you design separate routines for workdays, weekends, or specific days of the week."},
    {"question":"How is a routine different from a schedule?","answer":"A routine is a set of habitual actions done in sequence, while a schedule assigns specific times to tasks. Routines reduce decision fatigue by automating recurring behavior patterns."},
    {"question":"How long until a routine becomes automatic?","answer":"Most people need 2-3 weeks of consistent repetition for a routine to feel automatic. Using a routine creator app helps you stay consistent during the formation period."}
  ];

  const features = [
    {"title":"Morning Routines","description":"Design the perfect morning routine to start each day with intention.","icon":"🌅"},
    {"title":"Evening Routines","description":"Wind down effectively with evening routines that prepare you for tomorrow.","icon":"🌙"},
    {"title":"Weekly Routines","description":"Create different routines for weekdays, weekends, or specific days.","icon":"🔄"},
    {"title":"Timed Steps","description":"Each routine step can have a duration, so your routine fits your available time.","icon":"⏰"},
    {"title":"Routine Library","description":"Browse pre-built routines and customize them to fit your lifestyle.","icon":"📋"},
    {"title":"Routine Analytics","description":"Track routine completion and see which routines improve your productivity.","icon":"📊"}
  ];

  return (
    <PublicPageLayout>
      <Seo
        title="Routine Creator App 2026 | A routine creator app helps you design morning, evening, and daily routines that stick | GoalPlanner"
        description="A routine creator app helps you design morning, evening, and daily routines that stick. Build structure into your day without feeling restricted."
        canonicalPath="/routine-creator-app"
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "WebPage",
          name: "Routine Creator App",
          url: "https://goalplanner.io/routine-creator-app",
          description: "A routine creator app helps you design morning, evening, and daily routines that stick. Build structure into your day without feeling restricted.",
          mainEntity: {
            "@type": "FAQPage",
...
export default RoutineCreatorApp;
