  ...
  return (
    <PublicPageLayout>
      ...
      <section className="space-y-6 text-center py-12" id="hero">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900">Study Smarter, Not Harder</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button asChild size="lg" className="rounded-full bg-blue-600 hover:bg-blue-700">
            <Link to="/auth">Start Student Planning Free</Link>
          </Button>
      ...
      <section className="space-y-6" id="why-matters">
        <h2 className="text-3xl font-bold text-gray-900">Why Student Planning Changes Everything</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <Card className="border-green-200 bg-green-50">
            <CardHeader>
              <CardTitle className="text-green-900">🎯 With Planning</CardTitle>
            </CardHeader>
            <CardContent>
      ...
      <section className="space-y-6" id="planning-areas">
        <h2 className="text-3xl font-bold text-gray-900">Six Areas of Student Planning</h2>
        <p className="text-lg text-gray-600">
      ...
      <section className="space-y-6" id="study-strategies">
        <h2 className="text-3xl font-bold text-gray-900">Effective Study Strategies</h2>
        <p className="text-lg text-gray-600">
      ...
      <section className="space-y-6" id="daily-routine">
        <h2 className="text-3xl font-bold text-gray-900">Sample Daily Student Schedule</h2>
        <p className="text-lg text-gray-600">
        ...
        <div className="bg-blue-50 rounded-2xl p-8 border border-blue-200">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="space-y-3">
              <h3 className="font-semibold text-blue-900">🌅 Morning (6:00-9:00)</h3>
            ...
            <div className="space-y-3">
              <h3 className="font-semibold text-blue-900">☀️ Midday (9:00-15:00)</h3>
              <ul className="space-y-1 text-blue-800 text-sm">
                <li>• Classes & labs</li>
            ...
            <div className="space-y-3">
              <h3 className="font-semibold text-blue-900">🌙 Evening (15:00-22:00)</h3>
              <ul className="space-y-1 text-blue-800 text-sm">
      ...
      <section className="space-y-6" id="assignment-planning">
        <h2 className="text-3xl font-bold text-gray-900">Assignment Planning System</h2>
        <p className="text-lg text-gray-600">
        ...
        <div className="space-y-4">
          <div className="grid md:grid-cols-4 gap-4">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 text-center">Record every assignment immediately with due date and requirements</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
              ...
              <CardContent>
                <p className="text-gray-600 text-center">Divide large assignments into smaller milestones</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
              ...
              <CardContent>
                <p className="text-gray-600 text-center">Block time in your calendar for each milestone</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
              ...
              <CardContent>
                <p className="text-gray-600 text-center">Monitor progress and adjust as needed</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="space-y-6" id="exam-prep">
        <h2 className="text-3xl font-bold text-gray-900">Exam Preparation Timeline</h2>
        <p className="text-lg text-gray-600">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="border-green-200 bg-green-50">
            <CardHeader>
              <CardTitle className="text-green-900">4 Weeks Out</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-green-800">
          ...
          <Card className="border-blue-200 bg-blue-50">
            <CardHeader>
              <CardTitle className="text-blue-900">2-3 Weeks Out</CardTitle>
            </CardHeader>
            <CardContent>
      ...
      <section className="space-y-6" id="balance">
        <h2 className="text-3xl font-bold text-gray-900">Academic Success Needs Balance</h2>
        <p className="text-lg text-gray-600">
      ...
      <section className="space-y-6" id="cta">
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 border border-blue-100 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Ready to Ace Your Studies?</h2>
      ...
      <section className="space-y-6" id="related-topics">
        <h2 className="text-3xl font-bold text-gray-900">Master Student Success Skills</h2>
        <p className="text-lg text-gray-600">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600 mb-4">Master scheduling and prioritization</p>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600 mb-4">Organize assignments and tasks effectively</p>
              <Button asChild variant="outline" className="w-full">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600 mb-4">Set and achieve academic goals</p>
              <Button asChild variant="outline" className="w-full">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-600 mb-4">Strategies for focus and executive function</p>
              <Button asChild variant="outline" className="w-full">
      ...
      <section className="space-y-6" id="faq">
        <h2 className="text-3xl font-bold text-gray-900">Student Planning FAQ</h2>
