        ...
        <div className="space-y-6 text-foreground/80">
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <p>You grant us a limited, non-exclusive license to host, process, and display your content solely to provide the Service to you.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc ml-6 space-y-2">
                ...
                <li>Your access to Premium features is tied to your subscription status</li>
