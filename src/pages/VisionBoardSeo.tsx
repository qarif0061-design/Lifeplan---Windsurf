    ...
    <PublicPageLayout>
      ...
      <div className="space-y-10">
        <header className="space-y-3">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900">Vision Board</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Button asChild className="rounded-full bg-blue-600 hover:bg-blue-700">
              <Link to="/auth">Start turning your vision into action</Link>
            </Button>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-900">How to create a vision board</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="rounded-[2rem] border border-gray-100 bg-white shadow-sm">
              ...
              <CardContent className="text-gray-700">Create a secret or public board, search for goal-related pins, and organize them into sections (career, health, travel). Pin daily to reinforce your vision.</CardContent>
            </Card>
            <Card className="rounded-[2rem] border border-gray-100 bg-white shadow-sm">
              <CardHeader><CardTitle className="text-lg">In Canva</CardTitle></CardHeader>
              <CardContent className="text-gray-700">Use Canva's free vision board templates. Drag and drop images, add quotes, and export as a phone wallpaper or print. Easy to update as goals evolve.</CardContent>
            </Card>
            <Card className="rounded-[2rem] border border-gray-100 bg-white shadow-sm">
              <CardHeader><CardTitle className="text-lg">On Your Phone</CardTitle></CardHeader>
              <CardContent className="text-gray-700">Use a vision board app or create a photo album on your iPhone/Android. Set your vision board as your lock screen for daily reinforcement.</CardContent>
            </Card>
            <Card className="rounded-[2rem] border border-gray-100 bg-white shadow-sm">
              <CardHeader><CardTitle className="text-lg">On iPad / PowerPoint</CardTitle></CardHeader>
              <CardContent className="text-gray-700">Use iPad apps like Canva or Pinterest. For PowerPoint, create a single slide with images and text, then save as a wallpaper or present regularly.</CardContent>
            </Card>
          </div>
        </section>

        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-900">Vision board ideas for 2026</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-900">From vision board to action plan</h2>
          <div className="rounded-[2rem] border border-blue-100 bg-blue-50 p-7 shadow-sm">
            ...
            <div className="mt-6">
              <Button asChild className="rounded-full bg-blue-600 hover:bg-blue-700">
                <Link to="/auth">Create your goal plan</Link>
              </Button>
            </div>
          </div>
        </section>
